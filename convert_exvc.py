...
You just need a txt file with this format. the output will be saved in the destination "outdir/output_file_name". 
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        for line in tqdm(zip(titles, srcs, tgts)):
            ...
            print(os.path.join(args.outdir, f"{title}.wav"))
